...
function Upload() {
  ...
  const [_analyzedExpense, setAnalyzedExpense] = useState<{ id: number | string } | null>(null);
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      setAnalyzedExpense({ id: expense.id });
      setSuccess(true);
      ...
      const errorMessage = err instanceof Error ? err.message : '영수증 이미지 분석 실패';
